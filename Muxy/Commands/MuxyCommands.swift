    ...
    var body: some Commands {
        CommandGroup(replacing: .appSettings) {
            ...
            Button {
                ...
                Label("Extensions...".localized, systemImage: "puzzlepiece.extension")
            }
        ...
        CommandGroup(after: .appSettings) {
            Button {
                ...
                Label("Open Configuration...".localized, systemImage: "doc.text")
            }

            Button {
                performShortcutAction(.reloadConfig)
            } label: {
                Label("Reload Configuration".localized, systemImage: "arrow.clockwise")
            }
            ...
            Button {
                ...
                Label("Refresh Worktrees".localized, systemImage: "arrow.triangle.2.circlepath")
            }
            ...
            Button {
                ...
                Label("New Worktree".localized, systemImage: "plus")
            }
            ...
            Button {
                ...
                Label("Remove Current Worktree".localized, systemImage: "trash")
            }
            ...
            Button {
                ...
                Label("Install CLI".localized, systemImage: "terminal")
            }
        ...
        CommandGroup(replacing: .pasteboard) {
            Button("Cut".localized) { NSApp.sendAction(#selector(NSText.cut(_:)), to: nil, from: nil) }
                .keyboardShortcut("x", modifiers: .command)
            Button("Copy".localized) { NSApp.sendAction(#selector(NSText.copy(_:)), to: nil, from: nil) }
                .keyboardShortcut("c", modifiers: .command)
            Button("Paste".localized) { NSApp.sendAction(#selector(NSText.paste(_:)), to: nil, from: nil) }
                .keyboardShortcut("v", modifiers: .command)
            Button("Select All".localized) { NSApp.sendAction(#selector(NSText.selectAll(_:)), to: nil, from: nil) }
        ...
        CommandGroup(replacing: .newItem) {
            ...
            Menu("Open in IDE".localized) {
                ...
                if ideService.installedApps.isEmpty {
                    Button("No supported IDEs found".localized) {}
                        .disabled(true)
                } else {
            ...
            Menu("Custom Commands".localized) {
                if commandShortcuts.shortcuts.isEmpty {
                    Button("No Custom Commands".localized) {}
                        .disabled(true)
                } else {
        ...
        CommandGroup(after: .sidebar) {
            ...
            ForEach(1 ... 9, id: \.self) { index in
                if let action = ShortcutAction.projectAction(for: index) {
                    Button("Project %d".localized(index)) {
                        guard isMainWindowFocused else { return }
                        performShortcutAction(action)
                    }
                    .shortcut(for: action, store: keyBindings)
        ...
        CommandGroup(replacing: .help) {
            Button("Documentation".localized) {
                HelpLinks.openDocs()
            }

            Button("GitHub Repository".localized) {
                HelpLinks.openRepo()
            }

            Button("Mobile App Repository".localized) {
                HelpLinks.openMobileRepo()
            }

            Button("Discord".localized) {
                HelpLinks.openDiscord()
            }

            Divider()

            Button("What's New?".localized) {
                NotificationCenter.default.post(name: .openWhatsNewModal, object: nil)
            }

            Button("Report an Issue...".localized) {
